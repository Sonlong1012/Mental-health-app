...
//                 children: [
//                   FeelingButton(label: 'Happy', image: 'assets/happy.png',color: DefaultColors.pink, onTap: (){

//                   }),
//                   FeelingButton(label: 'Calm', image: 'assets/calm.png',color: DefaultColors.purple, onTap: (){

//                   }),
//                   FeelingButton(label: 'Relax', image: 'assets/relax.png',color: DefaultColors.orange, onTap: (){

//                   }),
//                   FeelingButton(label: 'Focus', image: 'assets/focus.png',color: DefaultColors.lightteal, onTap: (){
...
//               TaskCard(
//                 title: 'Morning',
//                 description: 'Lets open up to the thing that matters among the people',
...
import 'package:healthapp/features/meditation/presentation/bloc/daily_quote/daily_quote_state.dart';
...
import 'package:healthapp/features/meditation/presentation/widgets/feeling_button.dart';
import 'package:healthapp/features/meditation/presentation/widgets/task_card.dart';
                  ...
                  FeelingButton(
                    ...
                    onTap: () {
                      context.read<MoodMessageBloc>().add(
                        FetchMoodMessage('Today i am happy'),
                      );
                    },
                  ),
                  FeelingButton(
                    ...
                    onTap: () {
                      context.read<MoodMessageBloc>().add(
                        FetchMoodMessage('Today i am calm'),
                      );
                    },
                  ),
                  FeelingButton(
                    ...
                    onTap: () {
                      context.read<MoodMessageBloc>().add(
                        FetchMoodMessage('Today i am relax'),
                      );
                    },
                  ),
                  FeelingButton(
